...
|-------|--------------|---------|
| 
ame | Max 64 chars, lowercase letters/numbers/hyphens only | Unique identifier for the skill |
...
### 5. Vague Skill Names
- Good: processing-pdfs, nalyzing-spreadsheets
- Avoid: helper, utils, 	ools
