...
- **Files**: iles.autoSave, iles.exclude, iles.associations
- **Terminal**: 	erminal.integrated.fontSize, 	erminal.integrated.shell.*
- **Cursor-specific**: Settings prefixed with cursor. or ipopup.
