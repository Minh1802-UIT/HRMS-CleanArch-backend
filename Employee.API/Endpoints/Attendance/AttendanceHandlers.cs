...
namespace Employee.API.Endpoints.Attendance
{
  public static class AttendanceHandlers
  {
        ...
        ICurrentUser currentUser)
    {
      ...
      {
        return ResultUtils.Fail(ErrorCodes.UnlinkedAccount, "Tài kho?n c?a b?n chua du?c liên k?t v?i h? so nhân viên. Vui lòng liên h? HR.");
      }
    ...
    // 3. GET EMPLOYEE REPORT (Manager/HR xem c?a nhân viên)
    ...
    // 7. TRIGGER PROCESSING (Kích ho?t t?ng h?p d? li?u)
