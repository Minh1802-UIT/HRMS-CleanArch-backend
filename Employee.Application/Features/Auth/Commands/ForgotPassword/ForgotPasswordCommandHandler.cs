    ...
    public class ForgotPasswordCommandHandler : IRequestHandler<ForgotPasswordCommand, string>
    {
        ...
        <div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;'>
          ...
          <div style='text-align: center; margin: 25px 0;'>
            <a href='{resetLink}' style='background-color: #2563eb; color: white; padding: 12px 25px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 16px; display: inline-block;'>
              Cập nhật Mật khẩu
            </a>
          </div>
          <p style='margin-top: 15px; color: #6b7280; font-size: 14px;'>
            ⚠️ Link này sẽ hết hạn sau một thời gian. Nếu bạn không yêu cầu đặt lại, vui lòng bỏ qua email này.
          </p>
