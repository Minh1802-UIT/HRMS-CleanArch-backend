...
namespace Employee.Application.Features.Attendance.Services
{
    ...
    public class FaceVerificationService
    {
        ...
        /// Uses 0.40 as an ultra-strict threshold for Euclidean distance to absolutely prevent spoofing.
        /// </summary>
        public FaceMatchResult Verify(float[] checkInEmbedding, float[] registeredEmbedding, double threshold = 0.40)
        {
            ...
            {
                // Gradually drop from 80% to 0% as distance grows from threshold to 1.2
