...
public class ReviewLeaveRequestHandlerTests : IntegrationTestBase
{
  ...
  private IMongoCollection<LeaveRequest> LeaveRequests => Fixture.Database.GetCollection<LeaveRequest>("LeaveRequests");
  private IMongoCollection<LeaveType> LeaveTypes => Fixture.Database.GetCollection<LeaveType>("LeaveTypes");
