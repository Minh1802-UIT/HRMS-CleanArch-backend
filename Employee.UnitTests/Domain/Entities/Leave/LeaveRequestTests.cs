...
namespace Employee.UnitTests.Domain.Entities.Leave
{
  public class LeaveRequestTests
  {
    ...
    public void Update_WhenPending_ShouldSucceed()
    {
      ...
      // Act
      request.Update(LeaveTypeEnum.Sick, DateTime.UtcNow, newTo, "New Reason");
    ...
    public void Update_WhenNotPending_ShouldThrowException()
    {
      ...
      // Act & Assert
      Assert.Throws<InvalidOperationException>(() => request.Update(LeaveTypeEnum.Annual, DateTime.UtcNow, DateTime.UtcNow, "Update"));
    }
